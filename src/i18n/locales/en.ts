const en = {
  ...
  experiments: {
    ...
    "cellular-automata": {
      ...
      description:
        "A generalized Life engine where every rule is a genome you mutate and breed toward the patterns you like - not just Conway's Game of Life.",
      subtitle: "rules bred, not just run",
      tagline: "every rule is a genome",
      intro:
        "A generalized \"Generations\" cellular automaton: a cell is born, survives, or fades through decaying trail states based on its live neighbor count, covering everything from Conway's Game of Life to Brian's Brain and Star Wars in one engine. Hand-edit the birth/survive rule, or breed it - the sidebar runs live mutant offspring of the current rule, and clicking one adopts it as the grid's new law. Click and drag the canvas to paint or erase cells.",
      run: "run",
      pause: "pause",
      step: "step",
      step_hint: "Advance the field one generation while paused",
      reseed: "reseed",
      reseed_hint: "Fill the field with random noise at the density below",
      clear: "clear",
      clear_hint: "Wipe the field to all-dead, for hand-drawing a pattern",
      rule_title: "rule",
      ...
      preset_frogs: "frogs",
      birth: "birth",
      neighbor_birth_aria: "Birth on {{n}} neighbors",
      survive: "survive",
      neighbor_survive_aria: "Survive on {{n}} neighbors",
      states: "states",
      states_hint:
        "How many decay states a dying cell fades through before it's gone. 2 is classic on/off; higher reveals a fading trail (Brian's Brain, Star Wars).",
      lab_title: "breeding lab",
      lab_hint:
        "The current rule plus six random mutants, live. Click one to adopt it as the new rule.",
      lab_current: "current",
      lab_adopt_aria: "Adopt mutant rule {{rule}}",
      new_litter: "new litter",
      new_litter_hint: "Re-roll six fresh mutations of the current rule",
      ...
      brush_paint: "paint",
      brush_erase: "erase",
      brush_radius: "brush size",
      brush_radius_hint: "Radius in cells of the brush you paint or erase with",
      density: "density",
      density_hint: "Fill fraction used by reseed",
      speed: "speed",
      speed_hint: "Generations run per frame: higher fast-forwards the rule",
      look_title: "look",
      palette_ember: "ember",
      ...
      canvas_aria: "Generations cellular automaton simulation",
      webgl_fallback:
        "This experiment needs WebGL2, which your browser or device has disabled. The simulation can't start without it.",
      hint: "Toggle a neighbor count in the rule matrix, or adopt a mutant from the breeding lab, and watch the behavior completely change.",
      legend: "click and drag the canvas to paint - switch to erase in the session panel",
    },
    "fourier-drawing": {
